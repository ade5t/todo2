...
//        Отправляем запрос на получение access_token с помощью cURL, чтобы результат не выводить на экран
        $ku = curl_init();
        $url_for_access_token = 'https://oauth.vk.com/access_token?client_id=7021425&client_secret=There_secret_code&redirect_uri=http://'.Yii::$app->getRequest()->serverName.'/site/login_vk&code='.$code;
