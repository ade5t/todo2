...
//            надо обновить мыло
            if (isset($user1["user_id"]->vk_id) and isset($user1["email"]->email) and $user1["email"]->email != $this->email and $user1["user_id"]->vk_id == $this->user_id){
...
//            просто пустить
            else if (isset($user1["email"]->email) and !isset($user1["user_id"]->vk_id) and $user1["email"]->email == $this->email){
                return true;
            }

//            был акк вк, чел заходит с вк
//            ок
            else if (isset($user1["user_id"]->vk_id) and $user1["user_id"]->vk_id == $this->user_id){
                return true;
            }
